...
from app.data_base.data_base import reg, create_game, show_game_name, show_game_photo, show_game_plot, select_game_plot_for_id, select_game_photo_for_id, update_game_name, update_game_photo, update_game_plot
from app.fsm_states import AddGame, UpdateGame, GPT
from app.keyboards import main, game_menu, game_update_menu, cancle, cancle_menu, stop_chatting_sinnbo
...
# Команда старт TODO не забути дати назву боту та вписати її сюди
...
async def get_new_game_name(callback:CallbackQuery, state:FSMContext):
    ...
    await callback.answer('')
    await callback.message.edit_text(text='Нпишіть нову назву для гри🎮')
